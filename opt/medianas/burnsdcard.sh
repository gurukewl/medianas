...
# insert your own script in medianas-webinterface
# e.g. /opt/medianas/burnsdcard.sh /home/odroid/Callblocker_Image_06012015.img 2>&1 > /opt/medianas/cache/burnsdcard.txt
