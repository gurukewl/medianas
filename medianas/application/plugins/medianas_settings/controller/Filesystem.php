...
class Filesystem extends Service
{
    ...
    protected $_sambaconf = '/opt/medianas/samba.conf';
    ...
    /**
     * get Configuration of Samba Shares from /opt/medianas/samba.conf
     *
     * Config File uses this Options - Example
     * [SHARENAME]
     * comment = medianas share
     * path = /home/odroid
     * writeable = yes
     * create mode = 664
     */
    ...
    {
        $this->getSambaConfig();
        shell_exec("echo '#Samba Config medianas' > " . $this->_sambaconf);
    ...
    public function setSambaPassword()
    {
        ...
        if (strlen($pass) > 0) {
            $output = shell_exec('sudo /opt/medianas/setSambaPass.sh "' . $pass . '"');
