...
?>	    	  
	...
	<?php } ?>
		...
		<br /> <input id="addonurl" type="text" value="" name="addonurl"
			...
			<option
				value="http://cdn.medianas.com/kodi-15-pvr/medianas-u3-repository.zip">Kodi
				15 PVR-Addons Repository (for ODROID and Kodi version 15 ONLY!)</option>
			<option
				value="http://cdn.medianas.com/kodi-15-pvr/medianas-rpi-repository.zip">Kodi
