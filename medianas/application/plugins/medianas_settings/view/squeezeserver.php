...
?>
	...
	<br />
		...
		<select name="lmsplugin" style="width: 90%;">
			<option value="shairtunes2"><?php echo _('Bugfix for Shairtunes2 on medianas Raspberry with Debian Stretch - Fixes Libssl Error! (see debug log when Shairtunes2 Plugin is not working)') ?></option>
		...
		<div id="tabs-min">
		  ...
		  <?php echo _('Upload Settings File (created with the medianas export Settings tool) and Restore/Overwrite existing Settings');?>: 
