...
<h1 class="entry-header">
	<?php echo _("API Examples for medianas") ?>
</h1>
<div class="entry-content">
	...
	<?php echo _('HINT: Use the medianas OpenHAB Plugin as a powerful homeautomation server that already comes with support for Squeezebox Server, Alexa, Google Home and offers an easy integration in existing homeautomatisation environments.');?>
	<br /><br />	
	 ...
	 <div id="tabs-min">
	  <ul>
	    ...
	    <li><a href="#tabs-4">medianas Commands</a></li>
	  </ul>
	  <div id="tabs-1">
	    <p>
	  ...
	  <div id="tabs-2">
	    <p>
	    Start Kodi:<br /> 
	 		<div class="copyurl">http://<?php echo $_SERVER['HTTP_HOST'] ?>/plugins/medianas_settings/controller/Xbmc.php?action=start</div><br /><br />
	 	Stop Kodi: <br />
	 		<div class="copyurl">http://<?php echo $_SERVER['HTTP_HOST'] ?>/plugins/medianas_settings/controller/Xbmc.php?action=stop</div><br /><br />
	    </p>
	  </div>
	  <div id="tabs-3">
	    <p>
	 ...
	 <div id="tabs-4">
	    ...
	    Shutdown this Device: <br />
	 	  <div class="copyurl">http://<?php echo $_SERVER['HTTP_HOST'] ?>/plugins/medianas_settings/controller/Basic.php?action=shutdown</div><br />
	 	Restart Squeezebox Server: <br />
	 	  <div class="copyurl">http://<?php echo $_SERVER['HTTP_HOST'] ?>/plugins/medianas_settings/controller/Squeezeserver.php?action=restart</div><br />  
	 	Stop Squeezelite Player: <br />
	 	  <div class="copyurl">http://<?php echo $_SERVER['HTTP_HOST'] ?>/plugins/medianas_settings/controller/Squeezeplayer.php?action=stop</div><br />
	 	Start Squeezelite Player: <br />
	 	  <div class="copyurl">http://<?php echo $_SERVER['HTTP_HOST'] ?>/plugins/medianas_settings/controller/Squeezeplayer.php?action=start</div><br />
	 	Start Shairport Player: <br />
	 	  <div class="copyurl">http://<?php echo $_SERVER['HTTP_HOST'] ?>/plugins/medianas_settings/controller/Squeezeplayer.php?action=startap</div><br />
	 	Stop Shairport Player: <br />
	 	  <div class="copyurl">http://<?php echo $_SERVER['HTTP_HOST'] ?>/plugins/medianas_settings/controller/Squeezeplayer.php?action=stopap</div><br />
