...
class Exampleclass_Setup extends Service
{
    ...
    private function _doSomething()
    {
        ...
        $output = nl2br(shell_exec('ls /opt/medianas/'));
    ...
    public function showHelpSidebar()
    {
        ...
        $helpSidebar['content'] = _('<ul><li>This Plugin contains some example functions and code to copy&paste to create your own Plugin.</li><li>Use the <a href="https://www.medianas.com/en/portfolio/plugin-pluginbuilder-2/" target=_blank>Pluginbuilder</a> for development and the <a href="https://www.medianas.com/en/portfolio/plugin-remote-control/" target=_blank>Remote Control Plugin</a> for direct SSH-access.</li></ul>');
        $helpSidebar['wikilink'] = 'https://www.medianas.com/en/wiki/pluginbuilder/';
        return true;
    }
}
