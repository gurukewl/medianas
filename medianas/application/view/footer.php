...
<!--			<?php } ?>-->
	...
	<!--		<li><a href="<?php echo _('http://www.medianas.com/faq/') ?>"-->
	<!--			target="_blank" title="FAQ"><?php echo _('FAQ - Questions & Answers') ?></a></li>-->
	<!--		<li><a href="<?php echo _('http://www.medianas.com/en/addons/') ?>"-->
	<!--			target="_blank" title="Addons"><?php echo _('Addons and Feature Requests') ?></a></li>-->
	<!--		<li><a href="<?php echo _('http://www.medianas.com/en/forums/') ?>"-->
...
<footer>
	<div class="site-info">
		<br />
		<br />
				<?php echo _('Mediabase - An Online portal to setup a Media Server!'); ?>
				<br />
		<br />
	</div>
</footer>
