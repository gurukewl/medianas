...
<head>
<meta charset="UTF-8" />
<title>MediaBase Portal <?php echo $service->info->playername; ?></title>
...
<body>
	<div id="page">
		<header>
			<a href="/" class="logo" title="MediaBase - Your Media Solution"></a>
			...
			<div class="chooseplayer">
				...
				<span class="headerinfo">					
					...
					<!--	</div>-->
					<!--<?php } else { ?>-->
					<!--	<a href="/plugins/medianas_settings/controller/Basic.php"-->
